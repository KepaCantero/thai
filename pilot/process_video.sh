#!/usr/bin/env bash
# Download + parse a Comprehensible Thai (or any YT) video subtitle for pilot Q&A extraction.
# Usage:
#   ./pilot/process_video.sh VIDEO_ID SOURCE_TAG
# Example:
#   ./pilot/process_video.sh iT6HWhoL9KU days_of_week
set -euo pipefail
