...
function buildWordDict() {
  ...
  var extras = {
    ...
    'ปี': { ph: 'bpii', en: 'year' },
    'อาทิตย์': { ph: 'aa-thít', en: 'week / Sunday' },
    'สัปดาห์': { ph: 'sàp-daa', en: 'week' },
    'เมื่อวาน': { ph: 'müea-waan', en: 'yesterday' },
    ...
    'เท่าไหร่': { ph: 'thǎo-rài', en: 'how much?' },
    ...
    'ใบ' : { ph: 'bai', en: 'classifier (leaves, flats)' },
