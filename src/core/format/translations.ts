// English translations for Thai words/phrases/conversations. Ported
// verbatim from public/config.js:20-167. Preserves the original JS object
// literal ordering and duplicate-key behavior (later entries win).

export const THAI_EN: Record<string, string> = {
  'ฉัน': 'I (informal)',
  'ผม': 'I (masculine)',
  'คุณ': 'you',
  'เรา': 'we',
  ...
  'สอน': 'to teach',
  'ครู': 'teacher',
  'ยินดีค่ะ': "you're welcome (female)",
  'ยินดีครับ': "you're welcome (male)",
  'ได้รับ': 'to receive',
  'นิดหน่อย': 'a little',
  'ภาษา': 'language',
  'ไหม': 'question particle',
  'อยากได้': 'to want to get',
  'รู้จัก': 'to know/meet',
  // Extra particles & grammar
  'ไม่เป็นไร': 'no worries',
  'ห้องน้ำ': 'bathroom',
  'ห้อง': 'room',
  'ที่': 'at/in',
  'และ': 'and',
...
export const PHRASE_EN: Record<string, string> = {
  'สวัสดีครับผม': 'hello, I am (male)',
  'สวัสดีค่ะฉัน': 'hello, I am (female)',
  'ขอบคุณครับ': 'thank you (male)',
  'ขอบคุณค่ะ': 'thank you (female)',
  'ขอโทษครับ': 'excuse me (male)',
  'ขอโทษค่ะ': 'excuse me (female)',
  'เรากิน': 'we eat',
  'เขาไป': 'he/she goes',
  'คุณมี': 'you have',
  'เราชอบ': 'we like',
  ...
  'ใช่ไหม': "right?",
  'ไม่ใช่': "it's not",
  'ผมเอา': 'I want (something)',
  'ฉันจะไป': 'I will go',
  'ผมจะกิน': 'I will eat',
  'เขาอยากไป': 'he/she wants to go',
  'น้ำเย็น': 'cold water',
  'ผักอร่อย': 'vegetables are delicious',
  'อาหารเผ็ด': 'food is spicy',
  'อาหารอร่อย': 'food is delicious',
  'ผลไม้หวาน': 'sweet fruit',
  'อาหารไม่เค็ม': 'food is not salty',
  'ฉันไม่เผ็ด': "I don't want spicy",
  'ผมไม่ชอบเปรี้ยว': "I don't like sour",
  'ข้าวผัดไก่': 'chicken fried rice',
  'ฉันกินข้าว': 'I eat rice',
  'ผมกินไก่': 'I eat chicken',
  'เขากินหมู': 'he/she eats pork',
  'ผมชอบผัดไทย': 'I like pad thai',
  'ฉันชอบข้าว': 'I like rice',
  'ผมไม่อยากกินเนื้อ': "I don't want to eat beef",
  'ฉันอยากกินผลไม้': 'I want to eat fruit',
  'คุณชอบกินอะไร': 'what do you like to eat?',
  'น้ำสองแก้ว': 'two glasses of water',
  'ไก่ห้าตัว': 'five chickens',
  ...
  'คุณกินปลาไหม': 'do you eat fish?',
  'คุณไปที่ไหน': 'where are you going?',
  'คุณเป็นอะไร': 'what are you?',
  'เขามีอะไร': 'what does he/she have?',
  ...
  'ผมเอาอันนี้': 'I want this one',
  'เอาอันนั้นครับ': 'I want that one, please',
...
export const CONV_EN: Record<string, ConvEntry> = {
